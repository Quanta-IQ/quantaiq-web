...
export default function ChatInput(props: ChatInputProps) {
    ...
    const sendMessage = useMutation(api.messages.custombot.send);
    const clearThread = useMutation(api.messages.custombot.clear);
    ...
    const handleSend = async() => {
        ...
        if (inputValue != null && props.sessionID != null && props.botId != null){
            await sendMessage({
                message: inputValue,
